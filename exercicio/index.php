...
<html lang="pt-br">
    ...
    <body class="p-3 mb-2 bg-secondary text-white" style="margin: 30px">
        ...
        <center><a href="cadastro.php" class="btn btn-outline-info" tabindex="-1" role="button" aria-disabled="true">Novo cadastro</a></center>
        </br>
        <center>
            <table class="table table-info table-hover">
                ...
                <tbody>
                    <?php
                        include 'conecta.php';
                        $nomes = mysqli_query($conn, "SELECT * FROM pessoa_imc");

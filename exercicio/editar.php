<?php
    include("conecta.php");
    $id = $_GET['id'];
    $sql = "SELECT * FROM pessoa_imc WHERE id = $id";
    ...
    <body class="p-3 mb-2 bg-secondary text-white" style="margin: 30px">
        ...
        <center>
            <form action="upnome.php?id=<?php echo $id;?>" method="post">
                ...
                <input type="float" class="form-control" name="altura" value="<?php echo $altura;?>" required>
                <br>
                <label class="form-floating mb-3">PESO</label>
                <input type="float" class="form-control" name="peso" value="<?php echo $peso;?>" required>
                <br>
